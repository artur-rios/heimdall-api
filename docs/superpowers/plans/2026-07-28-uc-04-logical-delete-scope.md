...
**Files:**
- Create: `src/Application/ArturRios.Heimdall.Command/Input/DeleteScopeCommand.cs`
- Create: `src/Application/ArturRios.Heimdall.Command/Output/DeleteScopeCommandOutput.cs`
- Create: `src/Application/ArturRios.Heimdall.Command/Handlers/DeleteScopeCommandHandler.cs`
...
- Test: `tests/Application/ArturRios.Heimdall.Command.Tests/DeleteScopeCommandHandlerTests.cs`
...
In `src/Application/ArturRios.Heimdall.Shared/Messages/ScopeMessages.cs`, add after the `ScopeUpdatedSuccessfully` constant (line ~14):
...
In `src/Application/ArturRios.Heimdall.Shared/Messages/ScopeMessageMap.cs`, add an entry after the `ScopeUpdatedSuccessfully` mapping (line ~17):
...
Create `tests/Application/ArturRios.Heimdall.Command.Tests/DeleteScopeCommandHandlerTests.cs`:
...
```bash
dotnet test src/ArturRios.Heimdall.sln --filter "FullyQualifiedName~DeleteScopeCommandHandlerTests"
```
...
```bash
git add src/Application/ArturRios.Heimdall.Command/Input/DeleteScopeCommand.cs \
        src/Application/ArturRios.Heimdall.Command/Output/DeleteScopeCommandOutput.cs \
        src/Application/ArturRios.Heimdall.Command/Handlers/DeleteScopeCommandHandler.cs \
        ...
        tests/Application/ArturRios.Heimdall.Command.Tests/DeleteScopeCommandHandlerTests.cs
...
- Test: `tests/Presentation/ArturRios.Heimdall.WebApi.Tests/ScopeControllerDeleteTests.cs`
...
Create `tests/Presentation/ArturRios.Heimdall.WebApi.Tests/ScopeControllerDeleteTests.cs`:
...
```bash
dotnet test src/ArturRios.Heimdall.sln --filter "FullyQualifiedName~ScopeControllerDeleteTests"
```
...
In `src/Presentation/ArturRios.Heimdall.WebApi/Controllers/ScopeController.cs`, add after the `Update` action (after line ~46, before `List`):
...
(`DeleteScopeCommand` and `DeleteScopeCommandOutput` are already covered by the existing `using ArturRios.Heimdall.Command.Input;` and `using ArturRios.Heimdall.Command.Output;` at the top of the file.)

- [ ] **Step 4: Register the handler for DI**

In `src/Presentation/ArturRios.Heimdall.WebApi/Startup.cs`, add after the `UpdateScopeCommandHandler` registration (after line ~104):
...
git add src/Presentation/ArturRios.Heimdall.WebApi/Controllers/ScopeController.cs \
        ...
        tests/Presentation/ArturRios.Heimdall.WebApi.Tests/ScopeControllerDeleteTests.cs
