...
///     body. They are <c>[JsonIgnore]</c>, so they are not deserialized from the body and do not
///     appear in the request schema. The <see cref="IncludeAsJwtClaim" /> flag controls whether the
///     permission's <see cref="Name" /> is folded into the JWT issued to identities acting within the
///     owning scope.
/// </summary>
