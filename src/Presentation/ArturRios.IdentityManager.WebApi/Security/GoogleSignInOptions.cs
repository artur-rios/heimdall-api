...
///     <see cref="ArturRios.IdentityManager.Command.Services.IGoogleIdTokenVerifier" /> the API runs
...
public class GoogleSignInOptions
{
    ...
    /// </summary>
    public const string ClientIdsVariable = "IDENTITY_MANAGER_GOOGLE_CLIENT_IDS";
    ...
    /// </summary>
    public const string TestSigningSecretVariable = "IDENTITY_MANAGER_GOOGLE_TEST_SIGNING_SECRET";
