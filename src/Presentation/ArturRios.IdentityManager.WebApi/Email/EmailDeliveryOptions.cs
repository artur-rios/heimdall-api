...
{
    private const string VerificationUrlVariable = "IDENTITY_MANAGER_EMAIL_VERIFICATION_URL";
    private const string PasswordResetUrlVariable = "IDENTITY_MANAGER_PASSWORD_RESET_URL";
